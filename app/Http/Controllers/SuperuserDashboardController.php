...
class SuperuserDashboardController extends Controller
{
    ...
    public function settingsApiUpdate(Request $request)
    {
        $request->validate([
            ...
            'api_shipping_couriers' => 'nullable|array',
            'store_city_id' => 'nullable|integer',
            'api_payment_enabled' => 'nullable|boolean',
            'api_payment_provider' => 'nullable|string|in:midtrans,xendit,komerce',
        ...
        $data = [
            ...
            'api_shipping_couriers' => implode(',', $request->input('api_shipping_couriers', ['jne','pos','tiki'])),
            'store_city_id' => $request->input('store_city_id', '445'),
            'api_payment_enabled' => $request->has('api_payment_enabled') ? '1' : '0',
            'api_payment_provider' => $request->input('api_payment_provider', 'midtrans'),
