...
// TEMPORARY ROUTE UNTUK UPDATE DESKRIPSI
Route::get('/sync-descriptions', function() {
    $products = \App\Models\Product::where('name', 'like', 'Kain Batik Colet%')->get();
    $count = 0;
    ...
    foreach ($products as $product) {
        ...
        $description = "<p><strong>{$productName}</strong></p>
<p>Cari bahan batik yang halus dan nggak panas? Ini jawabannya!<br>
Kain Batik Solo dengan Kombinasi Batik Colet Motif Cantik dan Warna yang Mewah.</p>
<ul>
<li><strong>Ukuran:</strong> 2,00 x 1,15 Meter.</li>
<li><strong>Warna :</strong> 99% realpict, 1% tergantung layar perangkat yang digunakan.</li>
<li><strong>Bahan:</strong> Katun berkualitas (Jaminan halus & adem).</li>
<li><strong>Kondisi:</strong> Baru, kain lembaran (belum dijahit).</li>
<li><strong>Rekomendasi:</strong> Bagus untuk kemeja, tunik, rok lilit, atau dress.</li>
<li><strong>Proses:</strong> Tradisional Kombinasi Batik Colet</li>
</ul>
<p>Stok terbatas! Amankan motif favoritmu sekarang sebelum kehabisan.</p>";
    ...
    return "<h1>Berhasil mengupdate deskripsi untuk {$count} produk!</h1>";
});
