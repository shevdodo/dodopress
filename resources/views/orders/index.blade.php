                    ...
                    <div class="space-y-4">
                        ...
                        @if($order->status === 'pending')
                            <div class="mt-6 border-t border-gray-100 pt-6 flex justify-end">
                                <a href="{{ route('orders.payment', $order->id) }}" class="inline-flex items-center justify-center px-6 py-2.5 bg-brand-600 hover:bg-brand-700 text-white font-bold rounded-xl shadow-lg shadow-brand-600/30 transition transform hover:-translate-y-0.5">
