            ...
            <form action="{{ route('superuser.settings.footer.update') }}" method="POST" class="p-6 sm:p-8 space-y-8">
                ...
                <div>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <textarea name="footer_address" rows="3" class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-brand-500 focus:ring-brand-500 transition-colors bg-gray-50/50">{{ old('footer_address', $settings['footer_address'] ?? "Jl. Contoh No. 123\nKota Contoh, Provinsi 12345") }}</textarea>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">WhatsApp Number</label>
                            <input type="text" name="footer_whatsapp" value="{{ old('footer_whatsapp', $settings['footer_whatsapp'] ?? '081234567890') }}" class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-brand-500 focus:ring-brand-500 transition-colors bg-gray-50/50">
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div>
                        ...
                        <textarea name="footer_map_embed" rows="4" class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-brand-500 focus:ring-brand-500 transition-colors bg-gray-50/50 font-mono text-xs">{{ old('footer_map_embed', $settings['footer_map_embed'] ?? '<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d126773.79389552635!2d106.71064250000001!3d-6.595038!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69c5c5b5b5b5b5%3A0x0!2sJakarta!5e0!3m2!1sen!2sid!4v1700000000000!5m2!1sen!2sid" width="100%" height="250" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>') }}</textarea>
                ...
                <div>
                    ...
                    <div>
                        ...
                        <input type="text" name="footer_copyright" value="{{ old('footer_copyright', $settings['footer_copyright'] ?? '© ' . date('Y') . ' ' . ($settings['site_title'] ?? 'Your Website') . '. All rights reserved.') }}" class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-brand-500 focus:ring-brand-500 transition-colors bg-gray-50/50">
