<x-layouts.dashboard title="Edit Page">
    ...
    <form method="POST" action="{{ route('superuser.pages.update', $page) }}" enctype="multipart/form-data" class="flex flex-col lg:flex-row gap-8">
        ...
        <div class="flex-1">
            ...
            <div class="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div><label class="block text-sm font-semibold text-gray-700 mb-1">Badge</label><input type="text" name="cp[hero_badge]" value="{{ $cpContent['hero_badge'] ?? 'Hubungi Kami' }}" class="w-full border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:border-brand-500 focus:ring-brand-500/20 focus:ring"></div>
                    <div><label class="block text-sm font-semibold text-gray-700 mb-1">Title</label><input type="text" name="cp[hero_title]" value="{{ $cpContent['hero_title'] ?? 'Get In Touch' }}" class="w-full border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:border-brand-500 focus:ring-brand-500/20 focus:ring"></div>
                    <div class="sm:col-span-2"><label class="block text-sm font-semibold text-gray-700 mb-1">Subtitle</label><textarea name="cp[hero_subtitle]" rows="2" class="w-full border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:border-brand-500 focus:ring-brand-500/20 focus:ring">{{ $cpContent['hero_subtitle'] ?? '' }}</textarea></div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
                <div class="flex items-center gap-3 mb-5 pb-4 border-b border-gray-100">
                    ...
                    <h3 class="font-bold text-gray-900">Info Kontak</h3>
                </div>
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div><label class="block text-sm font-semibold text-gray-700 mb-1">Judul 1</label><input type="text" name="cp[info_title_1]" value="{{ $cpContent['info_title_1'] ?? 'Alamat' }}" class="w-full border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:border-brand-500 focus:ring-brand-500/20 focus:ring"></div>
                    <div><label class="block text-sm font-semibold text-gray-700 mb-1">Detail 1</label><input type="text" name="cp[info_desc_1]" value="{{ $cpContent['info_desc_1'] ?? '' }}" class="w-full border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:border-brand-500 focus:ring-brand-500/20 focus:ring"></div>
                    <div><label class="block text-sm font-semibold text-gray-700 mb-1">Judul 2</label><input type="text" name="cp[info_title_2]" value="{{ $cpContent['info_title_2'] ?? 'Telepon' }}" class="w-full border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:border-brand-500 focus:ring-brand-500/20 focus:ring"></div>
                    <div><label class="block text-sm font-semibold text-gray-700 mb-1">Detail 2</label><input type="text" name="cp[info_desc_2]" value="{{ $cpContent['info_desc_2'] ?? '' }}" class="w-full border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:border-brand-500 focus:ring-brand-500/20 focus:ring"></div>
                    <div><label class="block text-sm font-semibold text-gray-700 mb-1">Judul 3</label><input type="text" name="cp[info_title_3]" value="{{ $cpContent['info_title_3'] ?? 'Email' }}" class="w-full border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:border-brand-500 focus:ring-brand-500/20 focus:ring"></div>
                    <div><label class="block text-sm font-semibold text-gray-700 mb-1">Detail 3</label><input type="text" name="cp[info_desc_3]" value="{{ $cpContent['info_desc_3'] ?? '' }}" class="w-full border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:border-brand-500 focus:ring-brand-500/20 focus:ring"></div>
                    <div><label class="block text-sm font-semibold text-gray-700 mb-1">Judul 4</label><input type="text" name="cp[info_title_4]" value="{{ $cpContent['info_title_4'] ?? 'Jam Operasional' }}" class="w-full border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:border-brand-500 focus:ring-brand-500/20 focus:ring"></div>
                    <div><label class="block text-sm font-semibold text-gray-700 mb-1">Detail 4</label><input type="text" name="cp[info_desc_4]" value="{{ $cpContent['info_desc_4'] ?? '' }}" class="w-full border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:border-brand-500 focus:ring-brand-500/20 focus:ring"></div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
                <div class="flex items-center gap-3 mb-5 pb-4 border-b border-gray-100">
                    <div class="w-8 h-8 rounded-xl bg-brand-100 flex items-center justify-center">
                        <svg class="w-4 h-4 text-brand-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8" /></svg>
                    </div>
                    <h3 class="font-bold text-gray-900">Form</h3>
                </div>
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div><label class="block text-sm font-semibold text-gray-700 mb-1">Judul</label><input type="text" name="cp[form_title]" value="{{ $cpContent['form_title'] ?? 'Kirim Pesan' }}" class="w-full border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:border-brand-500 focus:ring-brand-500/20 focus:ring"></div>
                    <div><label class="block text-sm font-semibold text-gray-700 mb-1">Subjudul</label><input type="text" name="cp[form_subtitle]" value="{{ $cpContent['form_subtitle'] ?? '' }}" class="w-full border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:border-brand-500 focus:ring-brand-500/20 focus:ring"></div>
                    <div><label class="block text-sm font-semibold text-gray-700 mb-1">Tombol</label><input type="text" name="cp[form_button]" value="{{ $cpContent['form_button'] ?? 'Kirim Pesan' }}" class="w-full border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:border-brand-500 focus:ring-brand-500/20 focus:ring"></div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
                <div class="flex items-center gap-3 mb-5 pb-4 border-b border-gray-100">
                    ...
                    <h3 class="font-bold text-gray-900">Map & Social</h3>
                </div>
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div><label class="block text-sm font-semibold text-gray-700 mb-1">Judul Map</label><input type="text" name="cp[map_title]" value="{{ $cpContent['map_title'] ?? 'Lokasi Kami' }}" class="w-full border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:border-brand-500 focus:ring-brand-500/20 focus:ring"></div>
                    <div><label class="block text-sm font-semibold text-gray-700 mb-1">Judul Sosmed</label><input type="text" name="cp[social_title]" value="{{ $cpContent['social_title'] ?? 'Ikuti Kami' }}" class="w-full border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:border-brand-500 focus:ring-brand-500/20 focus:ring"></div>
                    <div class="sm:col-span-2"><label class="block text-sm font-semibold text-gray-700 mb-1">Map Embed</label><textarea name="cp[map_embed]" rows="3" class="w-full border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:border-brand-500 focus:ring-brand-500/20 focus:ring font-mono">{{ $cpContent['map_embed'] ?? '' }}</textarea></div>
                    <div><label class="block text-sm font-semibold text-gray-700 mb-1">Facebook</label><input type="text" name="cp[social_facebook]" value="{{ $cpContent['social_facebook'] ?? '#' }}" class="w-full border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:border-brand-500 focus:ring-brand-500/20 focus:ring"></div>
                    <div><label class="block text-sm font-semibold text-gray-700 mb-1">Instagram</label><input type="text" name="cp[social_instagram]" value="{{ $cpContent['social_instagram'] ?? '#' }}" class="w-full border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:border-brand-500 focus:ring-brand-500/20 focus:ring"></div>
                    <div><label class="block text-sm font-semibold text-gray-700 mb-1">Twitter</label><input type="text" name="cp[social_twitter]" value="{{ $cpContent['social_twitter'] ?? '#' }}" class="w-full border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:border-brand-500 focus:ring-brand-500/20 focus:ring"></div>
                    <div><label class="block text-sm font-semibold text-gray-700 mb-1">YouTube</label><input type="text" name="cp[social_youtube]" value="{{ $cpContent['social_youtube'] ?? '#' }}" class="w-full border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:border-brand-500 focus:ring-brand-500/20 focus:ring"></div>
                </div>
            </div>
        </div>
        @elseif($page->template === 'block')
    ...
    @if($page->template !== 'homepage' && $page->template !== 'contact' && $page->template !== 'block')
    <style>
