        ...
        <div class="w-full lg:w-80 space-y-6">
            <div class="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
                ...
                <div class="mb-6">
                    ...
                    <textarea id="meta_schema" name="meta_schema" rows="4" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-brand-500 focus:ring focus:ring-brand-500/20 px-4 py-2 text-sm font-mono text-gray-700" placeholder='<script type="application/ld+json">...</script>'>{{ old('meta_schema') }}</textarea>
                </div>
