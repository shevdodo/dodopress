...
<head>
    ...
    <style>
        ...
        aside.bg-brand-950 .h-16 { height: 48px !important; }
        ...
        header.bg-white { background-color: #1d2327 !important; color: #fff !important; border-bottom: none !important; height: 48px !important; min-height: 48px !important; }
        ...
        header input { background-color: #2c3338 !important; border-color: transparent !important; color: #fff !important; padding-top: 4px !important; padding-bottom: 4px !important; height: 30px !important; }
        ...
        <nav class="flex-1 overflow-y-auto sidebar-scroll px-3 py-4 space-y-1">
            @if(Auth::check() && Auth::user()->role === 'superuser')
                ...
                <div class="pt-3 mt-3 border-t border-brand-800/50">
                    ...
                    <a href="{{ route('superuser.settings.ai-visibility') }}"
                        class="flex items-center space-x-3 px-4 py-3 rounded-xl {{ request()->routeIs('superuser.settings.ai-visibility') ? 'text-white bg-gradient-to-r from-indigo-500 to-indigo-600 shadow-lg shadow-indigo-900/30 font-medium' : 'text-indigo-300 hover:text-white hover:bg-indigo-900/40' }} transition-all duration-200">
                        <div class="w-5 h-5 flex items-center justify-center">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z" /></svg>
                        </div>
                        <span class="{{ request()->routeIs('superuser.settings.ai-visibility') ? 'font-medium' : '' }}">AI Visibility</span>
                    </a>
            ...
            @elseif(Auth::check() && Auth::user()->role === 'admin')
                ...
                <!-- CUSTOMER SERVICE -->
                <div class="pt-3 mt-3 border-t border-brand-800/50">
                    <p class="px-4 text-[10px] uppercase tracking-widest text-brand-400 font-semibold mb-2">Customer Service</p>
                    <a href="{{ route('superuser.contact-messages.index') }}"
                        class="flex items-center space-x-3 px-4 py-3 rounded-xl {{ request()->routeIs('superuser.contact-messages.*') ? 'text-white bg-gradient-to-r from-brand-600 to-brand-700 shadow-lg shadow-brand-900/30 font-medium' : 'text-brand-200 hover:text-white hover:bg-brand-800/60' }} transition-all duration-200">
                        <div class="w-5 h-5 flex items-center justify-center">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
